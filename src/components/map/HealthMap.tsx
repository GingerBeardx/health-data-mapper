...
export default function HealthMap({
  ...
  const processedGeoJSON = React.useMemo(() => {
    ...
    const allValues = Object.values(healthData)
      .map((state) => state[selectedMetric])
    ...
    const features = statesGeoJSON.features.map((feature) => {
      ...
      const normalizedValue =
        value !== null && max !== min ? (value - min) / (max - min) : null;
    ...
    <div className="relative w-full h-full">
        ...
        >
          {processedGeoJSON && (
            <Source
              ...
              type="geojson"
              data={
                processedGeoJSON as unknown as import("geojson").FeatureCollection
              }
            >
              <Layer {...dataLayer} />
              <Layer {...borderLayer} />
      ...
      {hoverInfo && (
        ...
        >
          ...
          {healthData &&
            hoverInfo.feature.properties.name &&
            healthData[hoverInfo.feature.properties.name] && (
        ...
        <div className="flex flex-col space-y-2">
          <div className="flex items-center space-x-2">
            <div
              ...
              style={{
                background:
                  "linear-gradient(to right, #eff3ff, #c6dbef, #9ecae1, #6baed6, #4292c6, #2171b5, #08519c, #08306b)",
              }}
            ></div>
